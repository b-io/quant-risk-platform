...
TEST(MonteCarloTest, TestAgedHorizonResetSemantics) {
    ...
    // Check traces to see if reset happened
    // Path 0 and Path 1 should both start from the same frozen-aged baseline

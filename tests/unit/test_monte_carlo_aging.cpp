...
protected:
    void SetUp() override {
        ...
        MarketQuote q1;
        q1.id = "USD_OIS_1M";
        q1.instrument_type = QuoteInstrumentType::IRS;
        ...
        // The focused aging test reuses the same quotes for discount and forecast curves.
        CurveSpec spec_ibor;
...
TEST_F(MonteCarloAgingTest, AgedHorizonProducesNonZeroPV) {
    ...
    // Frozen-aged and shocked path valuations should remain priceable after horizon aging.

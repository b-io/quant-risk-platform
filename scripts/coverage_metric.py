"""Generate a stable test-coverage metric from gcovr Cobertura XML."""
...
def parse_coverage_metric(
    ...
    """Parses a gcovr Cobertura report into the platform coverage metric."""
    ...
    if lines_valid <= 0:
        raise ValueError("Coverage XML reports no valid lines")

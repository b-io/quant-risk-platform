...
- valuation reconciliation between pricing and risk views,
...
- `docs/architecture/ARCHITECTURE.md` explains the end-to-end engine layering.
- `docs/architecture/MARKET_AND_CURVES.md` explains normalized market-state construction.
- `docs/architecture/PYTHON_CPP_PERFORMANCE_AND_BINDINGS.md` explains how API design and performance engineering interact.

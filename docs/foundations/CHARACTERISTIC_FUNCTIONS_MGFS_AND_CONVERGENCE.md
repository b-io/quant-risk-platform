...
### 1.1 Existence Of The Characteristic Function
...
#### Example for 1.1 - The characteristic function stays bounded
...
### 1.2 Existence Conditions For The MGF
...
The underlying interpretation is that in some settings the strong law may fail or may require stronger assumptions, while the
weak law can still hold under weaker ones.

### 2.4 Role of the Weak Law When the Strong Law Holds

Because they address different questions and require different assumptions.
...
### 2.5 Interpretation of the Difference
...
> Weak law concerns closeness with high probability at large $n$. Strong law concerns actual sample-path convergence
> almost surely.

### 2.6 Role Of this in practice
...
## 3. Modes of convergence summary

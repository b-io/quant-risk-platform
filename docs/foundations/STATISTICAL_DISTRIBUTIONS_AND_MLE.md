...
### 2.1 Importance Of Maximum Likelihood
...
reference case because it is simple, bounded, and computationally inexpensive to simulate.
...
This is the **Cramer-Rao lower bound**. It says that no unbiased estimator can have variance below the inverse
...
## 6. Role Of Characteristic Functions
...
### 6.1 Uses Of Characteristic Functions
...
This is the simplest portfolio default-count model. It is analytically tractable, but it ignores heterogeneity across obligors

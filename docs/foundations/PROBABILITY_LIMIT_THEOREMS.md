...
## 4. Variance Decay Of The Sample Mean
...
$$
\left(\varphi_Y\left(\frac{u}{\sqrt{n}}\right)\right)^n \approx
\left(1-\frac{u^2}{2n}\right)^n \to e^{-u^2/2},
$$
...
## 11. Role Of Limit Theorems In A Quant Platform
...
The Law of Large Numbers and the Central Limit Theorem address two different questions.

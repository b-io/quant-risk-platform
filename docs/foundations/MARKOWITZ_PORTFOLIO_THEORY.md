...
---
A companion chapter, `docs/foundations/ASSET_PRICING_FOUNDATIONS.md`, connects Markowitz to CAPM, APT, Black-Scholes-Merton,
...
$$
\sigma_p^2 = 0.6^2 \times 0.08^2 + 0.4^2 \times 0.14^2 + 2(0.6)(0.4)(0.25)(0.08)(0.14) = 0.008224
$$
...
Implementation controls in portfolio construction:
...
This optimization step is explicit. The difficult part in practice is estimating $\mu$.
...
A more production-oriented objective is often:
...
The practical implication is not to discard mean-variance theory.
...
> production constraints, and controlling turnover. Production implementations therefore benefit from regularized

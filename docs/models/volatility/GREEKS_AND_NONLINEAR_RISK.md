...
This formula is useful for explain and hedging diagnostics, but it is only a local approximation. It becomes less
reliable for large shocks, barrier features, material smile dynamics, or jump-to-default exposure.

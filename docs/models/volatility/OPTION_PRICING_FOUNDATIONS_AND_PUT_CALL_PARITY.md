...
Still, large parity breaks indicate inconsistent market data or assumptions.
...
$$
\varepsilon_{\text{parity}} = \bigl(C_0 - P_0\bigr) - P(0,T)\bigl(F_0(T)-K\bigr) = 3.70 - 3.80 = -0.10
$$
...
Before calibrating local volatility, SABR, stochastic-volatility, or jump models, the implementation should ensure the

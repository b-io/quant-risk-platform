...
Main caveat: less convenient than Hull-White in many front-office implementations.
...
|---|---|---:|---:|---:|---|
| Vasicek | $dr_t=a(b-r_t)dt+\sigma dW_t$ | Yes | No | Yes | intuition and simple analytics |
...
For liquid vanilla option calibration, desks often rely more directly on Black-style models, SABR, or market models because those align more directly with market quoting conventions.

...
void bind_domain(py::module_& m) {
        ...
        py::class_<domain::CommodityCalendarSpreadOptionTrade, domain::Trade, std::shared_ptr<domain::CommodityCalendarSpreadOptionTrade>>(m, "CommodityCalendarSpreadOptionTrade")
            .def(py::init<>())
        ...
        py::class_<domain::CommodityForwardTrade, domain::Trade, std::shared_ptr<domain::CommodityForwardTrade>>(m, "CommodityForwardTrade")
            .def(py::init<>())
        ...
        py::class_<domain::CommodityFutureTrade, domain::Trade, std::shared_ptr<domain::CommodityFutureTrade>>(m, "CommodityFutureTrade")
            .def(py::init<>())
        ...
        py::class_<domain::CommodityFutureOptionTrade, domain::Trade, std::shared_ptr<domain::CommodityFutureOptionTrade>>(m, "CommodityFutureOptionTrade")
            .def(py::init<>())
        ...
        py::class_<domain::CommodityFutureStripTrade, domain::Trade, std::shared_ptr<domain::CommodityFutureStripTrade>>(m, "CommodityFutureStripTrade")
            .def(py::init<>())
        ...
        py::class_<domain::CommoditySpotTrade, domain::Trade, std::shared_ptr<domain::CommoditySpotTrade>>(m, "CommoditySpotTrade")
            .def(py::init<>())
        ...
        py::class_<domain::CommoditySwingTrade, domain::Trade, std::shared_ptr<domain::CommoditySwingTrade>>(m, "CommoditySwingTrade")
            .def(py::init<>())
        ...
        py::class_<domain::CreditIndexOptionTrade, domain::Trade, std::shared_ptr<domain::CreditIndexOptionTrade>>(m, "CreditIndexOptionTrade")
            .def(py::init<>())
        ...
        py::class_<domain::EquityForwardTrade, domain::Trade, std::shared_ptr<domain::EquityForwardTrade>>(m, "EquityForwardTrade")
            .def(py::init<>())
        ...
        py::class_<domain::EquityFutureTrade, domain::Trade, std::shared_ptr<domain::EquityFutureTrade>>(m, "EquityFutureTrade")
            .def(py::init<>())
        ...
        py::class_<domain::EquityOptionTrade, domain::Trade, std::shared_ptr<domain::EquityOptionTrade>>(m, "EquityOptionTrade")
            .def(py::init<>())

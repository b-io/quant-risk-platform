...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_cds(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_cds_index(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_cds_option(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_credit_bond(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_credit_index_option(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_commodity_calendar_spread_option(
    const domain::Trade& trade,
    const PricingContext& context) {
    const auto* typed = dynamic_cast<const domain::CommodityCalendarSpreadOptionTrade*>(&trade);
    return typed ? instruments::CommodityInstrumentFactory::create_commodity_calendar_spread_option(*typed, context) : nullptr;
}

QuantLib::ext::shared_ptr<QuantLib::Instrument> build_commodity_forward(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_commodity_future(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_commodity_future_option(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_commodity_future_strip(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_commodity_spot(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_commodity_swing(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_equity_forward(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_equity_future(
    const domain::Trade& trade,
    const PricingContext& context) {
...
QuantLib::ext::shared_ptr<QuantLib::Instrument> build_equity_option(
    const domain::Trade& trade,
    const PricingContext& context) {
...
const std::map<domain::ProductType, ProductPricingDefinition>& definitions() {
    static const std::map<domain::ProductType, ProductPricingDefinition> registry = {
        ...
        {domain::ProductType::CapFloor, ProductPricingDefinition{
            ...
            domain::SupportStatus::Supported}},
        {domain::ProductType::Cds, ProductPricingDefinition{
            no_realized_cashflows,
            build_cds,
            ...
            domain::SupportStatus::Supported}},
        {domain::ProductType::CdsIndex, ProductPricingDefinition{
            no_realized_cashflows,
            build_cds_index,
            "QRP::CdsInstrument/index spread-implied hazard curve",
            default_pricing_profile,
            domain::ProductType::CdsIndex,
            "CDS index pricing is supported from index spread curves, recovery quotes, and index factors",
            domain::SupportStatus::Supported}},
        {domain::ProductType::CdsOption, ProductPricingDefinition{
            no_realized_cashflows,
            build_cds_option,
            "QRP::CreditSpreadOptionInstrument/Black spread option",
            default_pricing_profile,
            domain::ProductType::CdsOption,
            "European CDS options are supported with quoted or trade-level credit spread volatility",
            domain::SupportStatus::Supported}},
        {domain::ProductType::CommodityCalendarSpreadOption, ProductPricingDefinition{
            no_realized_cashflows,
            ...
            "Commodity calendar spread options are supported from near/far futures and spread volatility",
            domain::SupportStatus::Supported}},
        {domain::ProductType::CommodityForward, ProductPricingDefinition{
            no_realized_cashflows,
            ...
            domain::SupportStatus::Supported}},
        {domain::ProductType::CommodityFuture, ProductPricingDefinition{
            no_realized_cashflows,
            ...
            domain::SupportStatus::Supported}},
        {domain::ProductType::CommodityFutureOption, ProductPricingDefinition{
            no_realized_cashflows,
            ...
            domain::SupportStatus::Supported}},
        {domain::ProductType::CommodityFutureStrip, ProductPricingDefinition{
            no_realized_cashflows,
            ...
            domain::SupportStatus::Supported}},
        {domain::ProductType::CommoditySpot, ProductPricingDefinition{
            no_realized_cashflows,
            ...
            domain::SupportStatus::Supported}},
        {domain::ProductType::CommoditySwing, ProductPricingDefinition{
            no_realized_cashflows,
            build_commodity_swing,
            "QRP::CommoditySwingInstrument/exercise-envelope approximation",
            default_pricing_profile,
            domain::ProductType::CommoditySwing,
            "Commodity swing contracts are supported with an intrinsic exercise-envelope approximation over configured exercise dates",
            domain::SupportStatus::PartiallySupported}},
        {domain::ProductType::CreditBond, ProductPricingDefinition{
            no_realized_cashflows,
            build_credit_bond,
            "QRP::CreditBondInstrument/spread-discounted cashflows",
            default_pricing_profile,
            domain::ProductType::CreditBond,
            "Credit bond pricing is supported from risk-free discount curves and issuer spread curves",
            domain::SupportStatus::Supported}},
        {domain::ProductType::CreditIndexOption, ProductPricingDefinition{
            no_realized_cashflows,
            build_credit_index_option,
            "QRP::CreditSpreadOptionInstrument/index Black spread option",
            default_pricing_profile,
            domain::ProductType::CreditIndexOption,
            "European credit index options are supported with quoted or trade-level spread volatility",
            domain::SupportStatus::Supported}},
        ...
        {domain::ProductType::Deposit, ProductPricingDefinition{
            ...
            domain::SupportStatus::Supported}},
        {domain::ProductType::EquityForward, ProductPricingDefinition{
            no_realized_cashflows,
            ...
            domain::SupportStatus::Supported}},
        {domain::ProductType::EquityFuture, ProductPricingDefinition{
            no_realized_cashflows,
            build_equity_future,
            "QRP::EquityFutureInstrument/listed future or theoretical carry",
            default_pricing_profile,
            domain::ProductType::EquityFuture,
            "Equity and index futures are supported from listed futures quotes or spot carry inputs",
            domain::SupportStatus::Supported}},
        {domain::ProductType::EquityOption, ProductPricingDefinition{
            no_realized_cashflows,
            build_equity_option,
            "QRP::EquityOptionInstrument/Black-Scholes plus binomial American exercise",
            default_pricing_profile,
            domain::ProductType::EquityOption,
            "European and American equity/index options are supported with dividend, borrow, and volatility inputs",
            domain::SupportStatus::Supported}},

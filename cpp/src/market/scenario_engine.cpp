 ...
 * 1. DTO-to-DTO: Returns a new MarketSnapshot with shocked values. Useful for audit and external
 * systems.
...
void ScenarioEngine::apply_scenario_to_state(MarketState& state,

...
inline TradeType parse_trade_type(const std::string& value) {
    if (value == "commodity_spot") return TradeType::CommoditySpot;
    if (value == "commodity_forward") return TradeType::CommodityForward;
    if (value == "commodity_future") return TradeType::CommodityFuture;
    if (value == "commodity_future_strip") return TradeType::CommodityFutureStrip;
    if (value == "commodity_future_option") return TradeType::CommodityFutureOption;
    if (value == "commodity_calendar_spread_option") return TradeType::CommodityCalendarSpreadOption;
    if (value == "commodity_swing") return TradeType::CommoditySwing;
    if (value == "credit_bond") return TradeType::CreditBond;
    if (value == "cds") return TradeType::Cds;
    if (value == "cds_index") return TradeType::CdsIndex;
    if (value == "cds_option") return TradeType::CdsOption;
    if (value == "credit_index_option") return TradeType::CreditIndexOption;
    if (value == "equity_spot") return TradeType::EquitySpot;
    if (value == "equity_forward") return TradeType::EquityForward;
    if (value == "equity_future") return TradeType::EquityFuture;
    if (value == "equity_option") return TradeType::EquityOption;
...
inline std::string to_string(TradeType type) {
    switch (type) {
        case TradeType::CommoditySpot: return "commodity_spot";
        case TradeType::CommodityForward: return "commodity_forward";
        case TradeType::CommodityFuture: return "commodity_future";
        case TradeType::CommodityFutureStrip: return "commodity_future_strip";
        case TradeType::CommodityFutureOption: return "commodity_future_option";
        case TradeType::CommodityCalendarSpreadOption: return "commodity_calendar_spread_option";
        case TradeType::CommoditySwing: return "commodity_swing";
        case TradeType::CreditBond: return "credit_bond";
        case TradeType::Cds: return "cds";
        case TradeType::CdsIndex: return "cds_index";
        case TradeType::CdsOption: return "cds_option";
        case TradeType::CreditIndexOption: return "credit_index_option";
        case TradeType::EquitySpot: return "equity_spot";
        case TradeType::EquityForward: return "equity_forward";
        case TradeType::EquityFuture: return "equity_future";
        case TradeType::EquityOption: return "equity_option";
...
inline ProductType product_type_from_trade_type(TradeType type) {
    switch (type) {
        case TradeType::CommoditySpot: return ProductType::CommoditySpot;
        case TradeType::CommodityForward: return ProductType::CommodityForward;
        case TradeType::CommodityFuture: return ProductType::CommodityFuture;
        case TradeType::CommodityFutureStrip: return ProductType::CommodityFutureStrip;
        case TradeType::CommodityFutureOption: return ProductType::CommodityFutureOption;
        case TradeType::CommodityCalendarSpreadOption: return ProductType::CommodityCalendarSpreadOption;
        case TradeType::CommoditySwing: return ProductType::CommoditySwing;
        case TradeType::CreditBond: return ProductType::CreditBond;
        case TradeType::Cds: return ProductType::Cds;
        case TradeType::CdsIndex: return ProductType::CdsIndex;
        case TradeType::CdsOption: return ProductType::CdsOption;
        case TradeType::CreditIndexOption: return ProductType::CreditIndexOption;
        case TradeType::EquitySpot: return ProductType::EquitySpot;
        case TradeType::EquityForward: return ProductType::EquityForward;
        case TradeType::EquityFuture: return ProductType::EquityFuture;
        case TradeType::EquityOption: return ProductType::EquityOption;
...
struct CreditBondTrade : public Trade {
    ...
    void from_json(const nlohmann::json& j) override {
        ...
        spread_quote_id = portfolio_detail::optional_string(details, {"spread_quote_id", "credit_spread_quote_id", "quote_id"});
    }
};
...
struct CdsIndexTrade : public Trade {
    ...
    void from_json(const nlohmann::json& j) override {
        ...
        index_name = portfolio_detail::optional_string(details, {"index_name", "issuer", "reference_entity", "underlier"});
        recovery_quote_id = portfolio_detail::optional_string(details, {"recovery_quote_id"});
        recovery_rate = portfolio_detail::optional_double(details, {"recovery_rate"}, recovery_rate);
        spread_quote_id = portfolio_detail::optional_string(details, {"spread_quote_id", "cds_quote_id", "quote_id"});
    }
...
struct CommodityForwardTrade : public Trade {
    ...
    void from_json(const nlohmann::json& j) override {
        ...
        quantity = j.contains("quantity")
            ? j.at("quantity").get<double>()
            : portfolio_detail::optional_double(details, {"quantity", "notional"});
        contract_price = portfolio_detail::optional_double(details, {"contract_price", "forward_price", "trade_price", "price"});
        forward_quote_id = portfolio_detail::optional_string(details, {"forward_quote_id", "future_quote_id", "quote_id"});
...
struct CommodityFutureTrade : public Trade {
    ...
    void from_json(const nlohmann::json& j) override {
        ...
        reference_price = portfolio_detail::optional_double(details, {"reference_price", "trade_price", "price"});
        future_quote_id = portfolio_detail::optional_string(details, {"future_quote_id", "quote_id"});
        maturity_date = portfolio_detail::optional_string(details, {"maturity_date", "expiry_date", "delivery_date"}, maturity_date);
        tenor = portfolio_detail::optional_string(details, {"tenor"});
        underlier = portfolio_detail::optional_string(details, {"underlier", "commodity", "benchmark"});
        unit = portfolio_detail::optional_string(details, {"unit"});
    }
...
struct CommodityFutureOptionTrade : public Trade {
    ...
    void from_json(const nlohmann::json& j) override {
        ...
        quantity = j.contains("quantity")
            ...
            : portfolio_detail::optional_double(details, {"quantity", "contracts", "notional"});
        expiry_date = portfolio_detail::optional_string(details, {"expiry_date", "option_expiry_date"});
        future_quote_id = portfolio_detail::optional_string(details, {"future_quote_id", "forward_quote_id", "quote_id"});
        maturity_date = portfolio_detail::optional_string(details, {"maturity_date", "future_maturity_date", "delivery_date"}, maturity_date);
        option_type = portfolio_detail::optional_string(details, {"option_type", "call_put"}, option_type);
...
struct EquityForwardTrade : public Trade {
    ...
    void from_json(const nlohmann::json& j) override {
        ...
        dividend_yield_quote_id = portfolio_detail::optional_string(details, {"dividend_yield_quote_id", "dividend_quote_id"});
...
struct EquityFutureTrade : public Trade {
    ...
    void from_json(const nlohmann::json& j) override {
        ...
        dividend_yield_quote_id = portfolio_detail::optional_string(details, {"dividend_yield_quote_id", "dividend_quote_id"});
        future_quote_id = portfolio_detail::optional_string(details, {"future_quote_id", "quote_id"});
        maturity_date = portfolio_detail::optional_string(details, {"maturity_date", "expiry_date", "settlement_date"}, maturity_date);
        quantity = quantity != 0.0 ? quantity : portfolio_detail::optional_double(details, {"quantity", "contracts", "notional"});
        reference_price = portfolio_detail::optional_double(details, {"reference_price", "trade_price", "price"});
        spot_quote_id = portfolio_detail::optional_string(details, {"spot_quote_id"});
        underlier = portfolio_detail::optional_string(details, {"underlier", "ticker", "index"});
    }
...
inline std::shared_ptr<Trade> make_trade(TradeType type) {
    switch (type) {
        case TradeType::CommoditySpot: return std::make_shared<CommoditySpotTrade>();
        case TradeType::CommodityForward: return std::make_shared<CommodityForwardTrade>();
        case TradeType::CommodityFuture: return std::make_shared<CommodityFutureTrade>();
        case TradeType::CommodityFutureStrip: return std::make_shared<CommodityFutureStripTrade>();
        case TradeType::CommodityFutureOption: return std::make_shared<CommodityFutureOptionTrade>();
        case TradeType::CommodityCalendarSpreadOption: return std::make_shared<CommodityCalendarSpreadOptionTrade>();
        case TradeType::CommoditySwing: return std::make_shared<CommoditySwingTrade>();
        case TradeType::CreditBond: return std::make_shared<CreditBondTrade>();
        case TradeType::Cds: return std::make_shared<CdsTrade>();
        case TradeType::CdsIndex: return std::make_shared<CdsIndexTrade>();
        case TradeType::CdsOption: return std::make_shared<CdsOptionTrade>();
        case TradeType::CreditIndexOption: return std::make_shared<CreditIndexOptionTrade>();
        case TradeType::EquitySpot: return std::make_shared<EquitySpotTrade>();
        case TradeType::EquityForward: return std::make_shared<EquityForwardTrade>();
        case TradeType::EquityFuture: return std::make_shared<EquityFutureTrade>();
        case TradeType::EquityOption: return std::make_shared<EquityOptionTrade>();

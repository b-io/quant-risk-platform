...
inline ProductType parse_product_type(const std::string& value) {
    // Commodity
    if (value == "commodity_spot") return ProductType::CommoditySpot;
    if (value == "commodity_forward") return ProductType::CommodityForward;
    if (value == "commodity_future") return ProductType::CommodityFuture;
    if (value == "commodity_future_strip") return ProductType::CommodityFutureStrip;
    if (value == "commodity_future_option") return ProductType::CommodityFutureOption;
    if (value == "commodity_calendar_spread_option") return ProductType::CommodityCalendarSpreadOption;
    ...
    if (value == "equity_forward") return ProductType::EquityForward;
    if (value == "equity_future") return ProductType::EquityFuture;
...
inline AssetClass asset_class_from_product_type(ProductType product_type) {
    switch (product_type) {
        // Commodity
        case ProductType::CommoditySpot: return AssetClass::Commodity;
        case ProductType::CommodityForward: return AssetClass::Commodity;
        case ProductType::CommodityFuture: return AssetClass::Commodity;
        case ProductType::CommodityFutureStrip: return AssetClass::Commodity;
        case ProductType::CommodityFutureOption: return AssetClass::Commodity;
        case ProductType::CommodityCalendarSpreadOption: return AssetClass::Commodity;
        ...
        case ProductType::EquityForward: return AssetClass::Equity;
        case ProductType::EquityFuture: return AssetClass::Equity;
...
inline std::string to_string(ProductType product_type) {
    switch (product_type) {
        // Commodity
        case ProductType::CommoditySpot: return "commodity_spot";
        case ProductType::CommodityForward: return "commodity_forward";
        case ProductType::CommodityFuture: return "commodity_future";
        case ProductType::CommodityFutureStrip: return "commodity_future_strip";
        case ProductType::CommodityFutureOption: return "commodity_future_option";
        case ProductType::CommodityCalendarSpreadOption: return "commodity_calendar_spread_option";
        ...
        case ProductType::EquityForward: return "equity_forward";
        case ProductType::EquityFuture: return "equity_future";
